...
# ===============LICENSE_END=========================================================
"""
Defines a pass-thru function as an Acumos model aka solution.
...
def predict(f1: float, f2: float, s: str) -> DemoComputeResult:
    '''Returns a named tuple with the sum of the numeric arguments, and the string argument.'''
    return DemoComputeResult(f1 + f2, s + ' sum')

model = Model(op=predict)
