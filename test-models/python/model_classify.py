...
from demo_compute_input import DemoComputeInput
from acumos.modeling import Model
# from acumos.session import AcumosSession

def classify(dci: DemoComputeInput) -> DemoComputeInput:
    '''Passes thru a named tuple with two numeric arguments and one string argument.'''
    return dci
