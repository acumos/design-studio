...
def multiply(f1: float, f2: float, s: str) -> DemoComputeResult:
    '''Returns a named tuple with the product of the numeric arguments, and the string argument.'''
    return DemoComputeResult(f1 * f2, s + ' product')

model = Model(op=multiply)
