...
public class ProtobufUtil {
	...
	/*private static Message parseProtobuf(String msgStructure) {
		ProtobufUtil protobufUtil = new ProtobufUtil();
		Message msg = protobufUtil.new Message();
		Scanner scanner = new Scanner(msgStructure);
	...
	/*public static void main(String[] args){
		Protobuf protobuf = ProtobufUtil.parseProtobuf("syntax =\"proto3\";\noption java_package = \"com.google.protobuf\";\noption java_outer_classname = \"DatasetProto\";\nservice kaziService {\n  rpc transform (DataFrame) returns (Prediction);\n}\nmessage DataFrameRow {\nint32 C1 = 1;\nint32 C2 = 2;\n}\nmessage DataFrame { \nrepeated DataFrameRow rows = 1;\n }\nmessage Prediction {\nrepeated int32 C3 = 1;\n}\n");
		System.out.println(protobuf.toString());
		
		ProtobufMessage message = ProtobufUtil.parseMessage("message DataFrame {\nrepeated DataFrameRow rows = 1;\n}\n");
