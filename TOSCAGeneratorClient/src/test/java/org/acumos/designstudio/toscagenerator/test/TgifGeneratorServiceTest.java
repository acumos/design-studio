...
public class TgifGeneratorServiceTest {
	...
	public void testCountTransport()throws Exception {
		...
		try {
			...
			ToscaGeneratorClient client = new ToscaGeneratorClient(" {\"toscaOutputFolder\":\" "+ localpath +"\", \"toscaGeneratorEndPointURL\":\"\", \"nexusEndPointURL\":\"\", \"nexusUserName\":\"\", \"nexusPassword\":\"\", \"nexusGroupId\":\"\", \"cmnDataSvcEndPoinURL\":\"\", \"cmnDataSvcUser\":\"\", \"cmnDataSvcPwd\":\"\"}");
			TgifGeneratorService tgifGeneratorService = new TgifGeneratorService();
			tgifGeneratorService.createTgif("3842ba62-8a0c-40cf-817a-ae9986e78aaf", "1.0.0", protobuf1, metaData);
