...
public class TgifGeneratorService {
	...
	public Artifact createTgif1(String solutionID, String version, String modelMetaData) throws CustomException{
	...
	public Artifact createTgif(String solutionID, String version,  String protobuf, String metaData) throws CustomException{
		logger.debug("--------  createTgif() Started ------------");
		Artifact result = null;
		String path = Properties.getTempFolderPath(solutionID, version);
		JSONParser parser = new JSONParser();
	...
	private Tgif populateTgif(String version, JSONObject metaDataJson, JSONObject protobufJson) {
		...
		//TODO : set the values from the Protobuf.json
		//Set services 
	...
	public static void main(String[] args){
		String metaData = "{\"schema\":\"acumos.schema.model:0.3.0\",\"methods\":{\"transform\":{\"output\":\"Prediction\",\"input\":\"DataFrame\",\"description\":\"transform\"}},\"name\":\"Gen\",\"runtime\":{\"name\":\"javageneric\",\"encoding\":\"protobuf\",\"version\":\"0.0.1\",\"dependencies\":{\"java\":{\"requirements\":[{\"name\":\"java\",\"version\":\"1.8.0_131\"},{\"name\":\"protoc\",\"version\":\"3.4.0\"},{\"name\":\"javac\",\"version\":\"1.8.0_131\"}],\"indexes\":[]}}}}";
		String protobuf = "{\"syntax\":\"proto3\",\"packageName\":\"\",\"listOfMessages\":[{\"messageName\":\"DataFrameRow\",\"messageargumentList\":[{\"rule\":\"\",\"type\":\"string\",\"name\":\"sepal_len\",\"tag\":\"1\"},{\"rule\":\"\",\"type\":\"string\",\"name\":\"sepal_wid\",\"tag\":\"2\"},{\"rule\":\"\",\"type\":\"string\",\"name\":\"petal_len\",\"tag\":\"3\"},{\"rule\":\"\",\"type\":\"string\",\"name\":\"petal_wid\",\"tag\":\"4\"},{\"rule\":\"\",\"type\":\"string\",\"name\":\"iris_type\",\"tag\":\"5\"}]},{\"messageName\":\"DataFrame\",\"messageargumentList\":[{\"rule\":\"repeated\",\"type\":\"DataFrameRow\",\"name\":\"rows\",\"tag\":\"1\"}]},{\"messageName\":\"Prediction\",\"messageargumentList\":[{\"rule\":\"\",\"type\":\"repeated\",\"name\":\"string\",\"tag\":\"1\"}]}]}";
		
		TgifGeneratorService service = new TgifGeneratorService();
		try {
			ToscaGeneratorClient client = new ToscaGeneratorClient(" {\"toscaOutputFolder\":\"D:/VS00485966/Acumos/Studio/Sprint6/Temp/\", \"toscaGeneratorEndPointURL\":\"\", \"nexusEndPointURL\":\"\", \"nexusUserName\":\"\", \"nexusPassword\":\"\", \"nexusGroupId\":\"\", \"cmnDataSvcEndPoinURL\":\"\", \"cmnDataSvcUser\":\"\", \"cmnDataSvcPwd\":\"\"}");
			service.createTgif("KDFOAIDFJ@#IJDFLKS", "1.1.1", protobuf, metaData);
		} catch (Exception e) {
