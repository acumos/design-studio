...
public class Properties {
	...
	// private static String propertyPath = "./TOSCAApplication.properties";
	...
	public static String getTempFolderPath(String solutionID, String version) {
		...
		//String path = mainProperties.getProperty("toscaOutputFolder", "");
	...
	public static String getToscaGeneratorEndPointURL() {
		//return mainProperties.getProperty("toscaGeneratorEndPointURL", "");
	...
	public static String getNexusEndPointURL() {
		//return mainProperties.getProperty("nexusEndPointURL", "");
	...
	public static void main(String[] args) {
		//System.out.println(Properties.getTOSCATypeCode("TOSCAPROTOBUF"));
	}
