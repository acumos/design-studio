...
public class GDMControllerTest {
	...
	public void setUp() throws Exception {
		//mockMvc = standaloneSetup(gdmController).build();
	...
	public void mapData() throws Exception {
		...
		//Mockito.when(gdmService.mapData(new ByteArrayInputStream(inputData))).thenReturn(new ByteArrayOutputStream());
	...
	public void mapDataNotNullData() throws Exception {
		...
		System.out.println("********* Length : " + bOutput.toString().length());
