...
import org.acumos.gdm.Application;
...
public class SwggerConfiguration {
    ...
    public Docket api() { 
        return new Docket(DocumentationType.SWAGGER_2)  
          .select()                                  
          .apis(RequestHandlerSelectors.basePackage("org.acumos.gdm.controller"))            
	...
	private ApiInfo apiInfo() {
		...
		ApiInfo apiInfo = new ApiInfo("Generic Data Mapper Service REST API", // title
				"Methods supporting all Generic Data Mapper Service.", // description
