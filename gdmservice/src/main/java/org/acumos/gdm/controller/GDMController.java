...
import org.acumos.gdm.util.Properties;
...
public class GDMController {
	...
	IGDMService gdmService;
	
	@ApiOperation(value = "transforms the protbuf format input data to the output and return outputdata in protobuf format")
	...
	public byte[] mapData(@RequestBody byte[] inputData){
		...
		OutputStream outputStream = gdmService.mapData(inputStream);
