...
public class ArtfactDetailsController {
	 ...
	 * @return
	 */
	/*@ApiOperation(value = "Get Type related metadata for a particular Solution ID")
	@RequestMapping(value = "/getTypeMetadata", method = RequestMethod.GET, produces = "text/plain")
	@ResponseBody
	public String getTypeMetadata(@RequestParam(value = "solutionId", required = false) String solutionId,
			@RequestParam(value = "version", required = false) String version,
			@RequestParam(value = "typeName", required = false) String typeName) {
		logger.debug(EELFLoggerDelegator.debugLogger, "------- getTypeMetadata() ------- : Begin");
		String result = iacumoseCatalog.getTypeMetadata(solutionId, version, typeName);
		logger.debug(EELFLoggerDelegator.debugLogger, "------- getTypeMetadata() ------- : End");
		return result;
	}*/
