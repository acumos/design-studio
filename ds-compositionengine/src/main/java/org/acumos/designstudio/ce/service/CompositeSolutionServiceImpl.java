...
public class CompositeSolutionServiceImpl implements ICompositeSolutionService {
	 ...
	 * @throws ServiceException 
	 */
	private BPDataBrokerMap getDataBrokerDetails(Nodes n) throws ServiceException {
		...
		if (null != propslst) {
			for (Property dbprops : propslst) {
				if (null != dbprops.getData_broker_map()) {
					// Set all the values from Property List of cdump to
					// Blueprint DataBrokerMap object
					...
					// Get the DBMapInput[] from DataBrokerMap from the Cdump
					// file
					...
					for (DBMapInput db : dbMapInLst) {
						...
						// set the all values into DataBroker Input Field of
						// BluePrint File
					...
					// Get the DBMapOutput[] from DataBrokerMap from the Cdump
					// file
