...
public class CompositeSolutionServiceImpl implements ICompositeSolutionService {
	...
	public String getCompositeSolutions(String userID, String visibilityLevel) throws AcumosException {
		...
		try {
			...
			RestPageResponse<MLPSolution> pageResponse = cdmsClient.findUserSolutions(nameKeyword, descriptionKeyword,active, userID, userAccessTypeCodes, modelTypeCodes, tags, restPageRequest);
			RestPageResponse<MLPSolution> pageResponse1 = cdmsClient.findPortalSolutions(nameKeyword, descriptionKeyword, active, ownerIds, portalAccessTypeCodes, modelTypeCodes, tags, null, null, restPageRequest);
			mlpSolutions = pageResponse.getContent();
			portalMLPSolutions = pageResponse1.getContent();
