...
public class SolutionController {
	...
	private boolean validateProperty(Property property) {
		...
		org.acumos.designstudio.vo.cdump.datamapper.DataMap dMap = new org.acumos.designstudio.vo.cdump.datamapper.DataMap();
		...
		try {
			...
			if (null == property || (null != property && null == property.getData_map())) {
				...
				if (dMap.getMap_outputs().length == 0) {
					org.acumos.designstudio.vo.cdump.datamapper.MapInputs[] map_inputs = dMap.getMap_inputs();
