 ...
 */
	public static DockerClient getDockerClient(DockerConfiguration config) throws AcumosException {
		SSLConfig sslConfig;
		if (config.isTlsVerify()) {
			if (config.getCertPath() == null)
				throw new ServiceException("certPath must be specified in secure mode");
