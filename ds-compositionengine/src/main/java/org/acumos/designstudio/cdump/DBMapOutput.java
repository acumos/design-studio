...
/**
 * This DataBroker POJO class defines output field attribute to construct output field json format 
 * for CDUMP file.
 */

public class DBMapOutput implements Serializable {

	private static final long serialVersionUID = -3848575029787965414L;
