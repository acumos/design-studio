...
public class DataBrokerMap implements Serializable{
	...
	private DBMapInputs[] map_inputs;
	private DBMapOutputs[] map_outputs;
	 ...
	 */
	public DBMapInputs[] getMap_inputs() {
		return map_inputs;
	}
	/**
	 * @param map_inputs the map_inputs to set
	 */
	public void setMap_inputs(DBMapInputs[] map_inputs) {
		this.map_inputs = map_inputs;
	}
	/**
	 * @return the map_outputs
	 */
	public DBMapOutputs[] getMap_outputs() {
		return map_outputs;
	}
	/**
	 * @param map_outputs the map_outputs to set
	 */
	public void setMap_outputs(DBMapOutputs[] map_outputs) {
