...
/**
 * This POKO DataBroker class defines different type of data broker types attribute,
 * SQL script info attribute,field separator of CSV file and input and output fields mapping of CSV file as well 
 * PROTObuf file input and output fields info.
 */
...
public class DataBrokerMap implements Serializable{
	...
	private DBMapInput[] map_input;
	private DBMapOutput[] map_output;
	 ...
	 */
	public void setMap_inputs(DBMapInput[] map_input) {
		this.map_input = map_input;
	}
	/**
