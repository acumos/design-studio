...
/**
 * This DataBroker POJO class defines the Column name CSV file, Column type and some other
 * fields to create JSON structure in CDUMP file
 */

public class DBInputField implements Serializable {

	private static final long serialVersionUID = 2231410323136675626L;
