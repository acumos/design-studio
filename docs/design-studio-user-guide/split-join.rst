...
Splitters are located in the **Data Transform Tools** palette.
    ...
    .. image:: ../images/design-studio-user-guide/split-join/COandSPL.jpg
...
#. After dragging the Splitter on the canvas, it should be displayed as rectangular icon and the input (on left-hand side) and output (on right-hand side) ports should be disabled
    ...
    .. image:: ../images/design-studio-user-guide/split-join/SplitterAfterDrag.jpg
...
#. On the right hand side in properties box, there will be a **Splitter Scheme Selector** button; click on it to display the pop-up window for scheme selection
	...
	.. image:: ../images/design-studio-user-guide/split-join/SplitterSelection.jpg
...
on both the input and output ports.
    ...
    .. image:: ../images/design-studio-user-guide/split-join/CopyBasedSPLwithModels.jpg
...
map button.
    ...
    .. image:: ../images/design-studio-user-guide/split-join/ParameterBasedSPLWithModel.jpg
...
mapping is valid or invalid (i,e. if the parameter types on both sides match).
    ...
    .. image:: ../images/design-studio-user-guide/split-join/SplitterMappingDetailsValid.jpg

If any of the mapping is invalid, then validation and blueprint generation will fail.

    .. image:: ../images/design-studio-user-guide/split-join/SplitterMappingDetailsError.jpg
...
#. After dragging the Collator on the canvas, it is displayed as rectangular icon and the input (on left hand side) and output (on right hand side) ports should be disabled
    ...
    .. image:: ../images/design-studio-user-guide/split-join/CollatorAfterDrag.jpg
...
#. On the right hand side in properties box, there will be a Collator Scheme Selector; click on it to display the pop-up window for scheme selection
    ...
    .. image:: ../images/design-studio-user-guide/split-join/CollatorSelectionSchema.jpg
...
acquires the message signature "repeated(M)".
    ...
    .. image:: ../images/design-studio-user-guide/split-join/ArrayBasedCollatorWithModels.jpg
...
be connected to it.
    ...
    .. image:: ../images/design-studio-user-guide/split-join/ParameterBasedCOWithModels.jpg
...
Validation Errors
    .. image:: ../images/design-studio-user-guide/split-join/CollatorMappingDetailsError.jpg

No Validation Errors
    .. image:: ../images/design-studio-user-guide/split-join/CollatorMappingDetailsValid.jpg
